...
Widget _buildTestApp(FakeNotificationService notificationService) {
  return ProviderScope(
    ...
    child: const MaterialApp(
      ...
      home: PendingNotificationsPageAndroid(),
    ),
  );
}

void main() {
  testWidgets('Android — shows an empty state when nothing is pending', (tester) async {
  ...
  testWidgets('Android — shows one row per pending notification with title and body', (tester) async {
