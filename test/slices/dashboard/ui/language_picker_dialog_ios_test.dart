...
void main() {
  testWidgets('option labels do not overflow on a narrow screen with Russian translations', (tester) async {
    // Matches the narrow 320dp Android AVD that first caught the equivalent Android bug.
    ...
    // currentOverride: ru so the selected-item "✓ " prefix renders too (longest label).
    unawaited(showCupertinoLanguagePicker(capturedContext, options, const Locale('ru'), ruL10n));
