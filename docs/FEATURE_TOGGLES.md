...
| `hurry_up_notification_enabled` | `true` | No hurry-up notification is scheduled for any showup; existing reminder and deadline notifications are unaffected | 2027-02-23 |
