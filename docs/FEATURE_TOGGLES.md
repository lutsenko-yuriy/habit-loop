...
| `hurry_up_notification_enabled` | `false` (WU1 of 4, HAB-246 — flips to `true` in the final ship WU) | No hurry-up notification is scheduled for any showup; existing reminder and deadline notifications are unaffected | — |
