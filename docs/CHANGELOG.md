...
- [user] Secondary dashboard actions (Language, About, Debug) are now grouped under a ⋯ menu button on both iOS and Android, keeping the navigation bar uncluttered
