...
- Two new `app_container_test.dart` tests guard against regression: `pactSyncRepositoryProvider` and `showupSyncRepositoryProvider` override is included when provided
