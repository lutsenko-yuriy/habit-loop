...
| Start date | |
| End date | |
| Audience | e.g. 20% of new users, iOS only |
| Remote Config flag | e.g. `exp_nnn_variant` |
| Ramp plan | e.g. 10% → 50% → 100% or kill |
| Stop rule | e.g. min 200 users or 2 weeks |

## Metrics
| Metric | Role | Baseline | Result |
|---|---|---|---|
| e.g. pact_created rate | Primary | | |
| e.g. D7 retention | Guardrail | | |
