...
│   │       └── noop_notification_service.dart           # NoopNotificationService — silent no-op for tests and debug/profile builds
│   └── remote_config/
│       ├── contracts/
