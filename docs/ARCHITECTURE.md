...
└── slices/
    ...
    │   ├── analytics/                 # PactCreatedEvent, PactStoppedEvent, PactTimelineAnalyticsScreen, PactTimelineLoadMoreEvent, PactTimelineEventTappedEvent (pact_timeline_analytics_events.dart — HAB-116)
