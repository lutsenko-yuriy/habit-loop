...
- [device_info_plus](https://pub.dev/packages/device_info_plus) — reads device model and OS version at runtime; used by the About screen to pre-fill the feedback Google Form URL as query params (HAB-149)
