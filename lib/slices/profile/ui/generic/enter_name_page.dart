...
import 'package:habit_loop/slices/profile/ui/android/enter_name_body_android.dart';
import 'package:habit_loop/slices/profile/ui/generic/display_name_provider.dart';
import 'package:habit_loop/slices/profile/ui/ios/enter_name_body_ios.dart';
...
/// Owns save/skip logic; [EnterNameBodyIos]/[EnterNameBodyAndroid] are pure
/// chrome.
class EnterNamePage extends ConsumerStatefulWidget {
  const EnterNamePage({super.key, required this.onDone});
...
class _EnterNamePageState extends ConsumerState<EnterNamePage> {
  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.iOS) {
      return EnterNameBodyIos(controller: _controller, onSave: _onSave, onSkip: _onSkip);
    }
    return EnterNameBodyAndroid(controller: _controller, onSave: _onSave, onSkip: _onSkip);
  }
}
